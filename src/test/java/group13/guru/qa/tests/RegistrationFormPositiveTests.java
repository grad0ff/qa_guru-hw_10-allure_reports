package group13.guru.qa.tests;

import com.codeborne.selenide.SelenideElement;
import group13.guru.qa.pages.StudentsRegistrationFormPage;
import group13.guru.qa.tests.test_data.TestSimpleData;
import group13.guru.qa.tests.test_data.enums.Genders;
import group13.guru.qa.tests.test_data.enums.Hobbies;
import group13.guru.qa.tests.test_data.enums.StatesCities;
import group13.guru.qa.tests.test_data.enums.Subjects;
...
class RegistrationFormPositiveTests extends TestBase {
    ...
    void allFieldsTest() {
        assert TestSimpleData.filePhoto.exists();
...
//        registrationFormPage.selectStateCity(TestSimpleData.STATE, TestSimpleData.CITY);
    ...
    @MethodSource("group13.guru.qa.tests.test_data.PositiveTestDataProvider#firstNameData")
    ...
    @MethodSource("group13.guru.qa.tests.test_data.PositiveTestDataProvider#lastNameData")
    ...
    @MethodSource("group13.guru.qa.tests.test_data.PositiveTestDataProvider#emailAddressData")
    ...
    @MethodSource("group13.guru.qa.tests.test_data.PositiveTestDataProvider#phoneNumberData")
    ...
    @MethodSource("group13.guru.qa.tests.test_data.PositiveTestDataProvider#dateOfBirthData")
    ...
    @MethodSource("group13.guru.qa.tests.test_data.PositiveTestDataProvider#imageFileData")
    ...
    @MethodSource("group13.guru.qa.tests.test_data.PositiveTestDataProvider#addressData")
